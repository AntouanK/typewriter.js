...
(function(){
	...
	window.typewriter = (function(){
		...
		//	start the writing of the text
		//	can pass options 
		//	{
		//		timing: ms between each typing,
		//		onEnd: callback function after typing ends
		//	}
		//	
		//	* clear() will stop the writing process
		...
		//	destroy a typewriter ( also removes cursor )
